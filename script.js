const messages = [
        "Thanks so much for considering me. Please see here for a link to the services and price packages that I offer. Let me know if you have any questions!",
        ...
        "Thanks for reaching out! I typically charge a flat fee for this kind of advice, so I'm unable to answer this via DMs but I'll drop a link below where you can book a consultation with me!",
        ...
        "Thank you for the note! I have to pass on unpaid work right now to stay focused on my current clients, but I wish you the best with this project.",
